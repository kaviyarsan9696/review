...
<body>
	<?php
	if(!isset($_POST['submit'])&&!isset($_POST['show_only_manager']) && !isset($_POST['show_only_cse']) && !isset($_POST['show_only_hr'])){?>
			...
			while($row = mysqli_fetch_array($query))
			{
				...
				<tr >	
					...
					<td><?php echo  $row['2'];?></td>
	             	<td><a href="/review/details.php?id=<?php echo $row['3']; ?>"><input type="button" name="" value="show_only_cse" style="background-color: chocolate; color: white; border-radius: 8px; font-style: oblique; font-weight: bolder;"></td></a>
